...
def generate_launch_description():
    ...
    rviz_pkg_dir = os.path.join(get_package_share_directory('vehicle_slam'), 'rviz', 'map.rviz')
    print(rviz_pkg_dir)

    slam_pkg_dir = os.path.join(get_package_share_directory('vehicle_slam'), 'launch')
    print(slam_pkg_dir)
